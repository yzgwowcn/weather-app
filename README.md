...
- **海南玻璃海候选（含自选点）**：全部海南预设点，以及搜索、地图、坐标或收藏得到的海南自选点，结合 EC 逐小时低中云、降水、10 米风和 Open-Meteo Marine 有效浪高（`wave_height`）/风浪/涌浪给出 08:00–18:00 候选时段。较佳候选要求遮蔽≤50%、风≤12 km/h、有效浪高≤0.5 m、风浪≤0.2 m、涌浪≤0.5 m；可关注放宽至 70%、16 km/h、0.8/0.3/0.7 m。高云不单独否决；结果不判断水质、岸边浪花和瞬时涌浪，不替代码头或景区实况。
